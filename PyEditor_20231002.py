...
class exe:
    ...
    def highlight_syntax(event=None):
        ...
        # 应用语法高亮
        exe.apply_highlight("keyword1", keyword_pattern1, code)
        exe.apply_highlight("keyword2", keyword_pattern2, code)
        exe.apply_highlight("keyword3", keyword_pattern3, code)
        exe.apply_highlight("string", string_pattern, code)
        exe.apply_highlight("comment", comment_pattern, code)
...
editor.bind("<KeyRelease>", exe.highlight_syntax)
editor.bind("<KeyRelease>", lambda event: exe.get_current_line_number())
editor.bind("<Button-1>", lambda event: exe.get_current_line_number())
editor.bind("<ButtonPress-1>", lambda event: exe.get_current_line_number())
editor.bind("<ButtonRelease-1>", lambda event: exe.get_current_line_number())
...
editor.insert(1.0,'''#欢迎使用Python Editor.py!
###############################
